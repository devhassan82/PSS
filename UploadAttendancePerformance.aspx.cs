...
namespace PSS
{
    public partial class UploadAttendancePerformance : System.Web.UI.Page
    {
        ...
        private void BindEmpDataTable(DataTable dtPerformance, string subject, ref DataTable _dtperformance)
        {
            ...
            foreach (DataRow dr in dtPerformance.Rows)
            {
                ...
                {
                    FillRow(count, dr["EmployeeCode"].ToString(),Convert.ToInt32(dr["AttendancePercentage"].ToString()), ref _dtperformance);
                }
            }
        }
        ...
        private void FillRow(int count, string EmployeeCode,int AttendancePercentage, ref DataTable dt)
        {
            ...
            dr[2] = AttendancePercentage.ToString();
            dt.Rows.Add(dr);
        }
