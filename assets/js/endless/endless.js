...
$(function () {
    ...
    //Alarm speaker working 
    //====================================================================    
    //$(function () {
    //    //'use strict';
    //    if (localStorage.getItem("IsSoundOn") != null) {
    //        if (localStorage.getItem("IsSoundOn") === 'unmute') {
    //            //alert(localStorage.getItem("IsSoundOn"))
    //            $('.img-swap').attr("src", "/assets/img/unmute.png");
    //        }
    //        else if (localStorage.getItem("IsSoundOn") === 'mute') {
    //            //alert(localStorage.getItem("IsSoundOn"))
    //            $('.img-swap').attr("src", "/assets/img/mute.png");
    //        }
    //    }
    //    else {
    //        //alert(localStorage.getItem("IsSoundOn"))
    //        localStorage.setItem("IsSoundOn", 'mute');
    //    }
    //});
    
    //$("#speaker-setting-icon").on('click', function () {
    //    //unmute
    //    if ($(this).find('img').attr("class") == "img-swap") {
    //        $(this).find('img').attr("src", "/assets/img/unmute.png");
    //        localStorage.setItem("IsSoundOn", 'unmute');
    //    } else {
    //        //localStorage.removeItem("IsSoundOn");
    //        $(this).find('img').attr("src", "/assets/img/mute.png");
    //        localStorage.setItem("IsSoundOn", 'mute');
    //    }
